...
| Waves 3–7 remainder — bank reconciliation ✅ (v0.26 CSV flow), live connectors (store/payment/shipping APIs), customer payment portal (needs Edge Function — deferred), mobile/POS/offline, Documents/HR/Manufacturing modules | Mostly not started — see governance build packs |
