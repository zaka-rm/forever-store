...
export function RoutineCTA() {
  ...
  return (
    <SectionReveal className="container-px mx-auto max-w-7xl py-10">
      <RevealItem className="relative overflow-hidden rounded-5xl bg-ink px-8 py-16 text-center sm:px-16 sm:py-20">
        ...
        <div className="relative mx-auto flex max-w-2xl flex-col items-center">
          ...
          <h2 className="text-balance font-display text-4xl text-cream sm:text-5xl">
            {cta.title}<span className="font-extrabold text-sage-300">{cta.titleAccent}</span>
          </h2>
          <p className="mt-5 max-w-md text-base leading-relaxed text-cream/70">{cta.body}</p>
          <div className="mt-8">
