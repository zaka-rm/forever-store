...
Deno.serve(async (req: Request) => {
  ...
  let payload: { to?: string; body?: string; channel?: "whatsapp" | "sms"; workspaceId?: string; customer?: string };
  ...
  if (!to || !body || !workspaceId) return json({ error: "Missing 'to', 'body', or 'workspaceId'" }, 400);
